...
const Footer = () => {
    ...
    return(
        <div className={theme === "dark" ? "md:hidden flex px-4 py-2 fixed bottom-0 inset-x-0 z-10 bg-gray-800 flex-row space-x-20 justify-center" : "md:hidden flex px-4 py-2 fixed bottom-0 inset-x-0 z-50 bg-blue-800 flex-row space-x-20 justify-center"}>
