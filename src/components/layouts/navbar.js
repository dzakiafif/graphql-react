            ...
            <div className="flex justify-between place-items-center py-1 px-4 md:flex md:justify-between md:px-6 md:py-4 md:place-items-center">
                ...
                <div className="flex flex-row place-items-center space-x-10">
                    ...
                    <div onClick={() => handleToggleTheme()}>
                        <div className={theme === "dark" ? 'flex w-20 h-10 bg-gray-600 m-2 rounded-full transition-all duration-500' :'flex w-20 h-10 bg-blue-600 m-2 rounded-full transition-all duration-500'}>
                            <span className={theme === "dark" ? 'h-10 w-10 bg-white rounded-full ml-10 transition-all duration-500': 'h-10 w-10 bg-white rounded-full transition-all duration-500'}></span>
                        </div>
                    </div>
                </div>
            </div>
